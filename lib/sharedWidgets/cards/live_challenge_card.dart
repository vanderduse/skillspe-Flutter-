...
class LiveChallengeCard extends ChallengeCard {
        ...
        child: SizedBox(
          ...
          child: Image.network(
            ...
            errorBuilder: (context, error, stackTrace) =>
                Image.network('https://via.placeholder.com/40x40'),
            loadingBuilder: (context, child, loadingProgress) => Image.network(
                'https://via.placeholder.com/40x40'), // Cover the circular space
          ),
        ),
      ),
    );
